...
from . import views
from .views import register, user_login, user_logout, book_ticket
...
urlpatterns = [
    ...
    path(
        "book/confirm/<str:unique_seat_id>/",
        views.confirm_booking,
        name="confirm_booking",
    ),
    path(
        "book/confirm/<path:unique_seat_id>/download/",
        download_booking_pdf,
        name="download_booking_pdf",
    ),
    path(
        "book/payment/<path:unique_seat_id>/",
        views.initiate_payment,
        name="initiate_payment",
    ),
    path(
        "book/process_payment/<path:unique_seat_id>/",
